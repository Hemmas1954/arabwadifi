  ...
  const rulesData = [
    {
      ...
      sources: [
        'أحمد المتوكل، اللسانيات الوظيفية مدخل نظري، ط2، دار الكتاب الجديد المتحدة، بيروت-لبنان، 2010، ص139 حتى 144.',
        'أحمد المتوكل، الوظيفة والبنية مقاربات وظيفية لبعض قضايا التركيب في اللغة العربية، د ط، د ن، الزباط، 1993، ص13.'
      ]
    },
    {
      id: 2,
      ...
      sources: [
        'أحمد المتوكل، اللسانيات الوظيفية مدخل نظري، ط2، دار الكتاب الجديد المتحدة، بيروت-لبنان، 2010، ص145.',
        'أحمد المتوكل، الوظيفة والبنية مقاربات وظيفية لبعض قضايا التركيب في اللغة العربية، د ط، د ن، الزباط، 1993، ص13.'
      ]
    },
    {
      ...
      sources: [
        'أحمد المتوكل، اللسانيات الوظيفية مدخل نظري، ط2، دار الكتاب الجديد المتحدة، بيروت-لبنان، 2010، ص145-146.',
        'أحمد المتوكل، الوظيفة والبنية مقاربات وظيفية لبعض قضايا التركيب في اللغة العربية، د ط، د ن، الزباط، 1993، ص15.'
      ]
    },
    {
      id: 4,
      ...
      sources: [
        'أحمد المتوكل، اللسانيات الوظيفية مدخل نظري، ط2، دار الكتاب الجديد المتحدة، بيروت-لبنان، 2010، ص146-147-148.',
        'أحمد المتوكل، الوظيفة والبنية مقاربات وظيفية لبعض قضايا التركيب في اللغة العربية، د ط، د ن، الزباط، 1993، ص15.'
      ]
    },
    {
      id: 5,
      title: 'الوظائف التداولية بالنظر إلى وضعها بالنسبة للحمل',
      content: [
      ...
      sources: [
        'أحمد المتوكل، اللسانيات الوظيفية مدخل نظري، ط2، دار الكتاب الجديد المتحدة، بيروت-لبنان، 2010، ص151-152-153.',
        'أحمد المتوكل، الوظيفة والبنية مقاربات وظيفية لبعض قضايا التركيب في اللغة العربية، د ط، د ن، الزباط، 1993، ص17.'
      ]
    },
    {
      id: 6,
      title: 'إسناد الوظيفتين المحور وبؤرة الجديد إلى الحديين الفاعل والمفعول',
      content: [
      ...
      sources: [
        'أحمد المتوكل، اللسانيات الوظيفية مدخل نظري، ط2، دار الكتاب الجديد المتحدة، بيروت-لبنان، 2010، ص153-154-155-156.',
        'أحمد المتوكل، الوظيفة والبنية مقاربات وظيفية لبعض قضايا التركيب في اللغة العربية، د ط، د ن، الزباط، 1993، ص19.'
      ]
    },
    {
      id: 7,
      title: 'القوة الإنجازية الحرفية يؤثر لها بمخصص حمل "بسيط"',
      content: [
      ...
      sources: [
        'أحمد المتوكل، اللسانيات الوظيفية مدخل نظري، ط2، دار الكتاب الجديد المتحدة، بيروت-لبنان، 2010، ص 156.',
        'أحمد المتوكل، الوظيفة والبنية مقاربات وظيفية لبعض قضايا التركيب في اللغة العربية، د ط، د ن، الزباط، 1993، ص20.'
      ]
    },
    {
      id: 8,
      title: 'القوتان الإنجازيتان الحرفية والمستلزمة يؤثر لهما بواسطة مخصص حمل "مركب"',
      content: [
      ...
      sources: [
        'أحمد المتوكل، اللسانيات الوظيفية مدخل نظري، ط2، دار الكتاب الجديد المتحدة، بيروت-لبنان، 2010، ص 157-158.',
        'أحمد المتوكل، الوظيفة والبنية مقاربات وظيفية لبعض قضايا التركيب في اللغة العربية، د ط، د ن، الزباط، 1993، ص20.'
      ]
    },
    {
      ...
      sources: [
        'أحمد المتوكل، اللسانيات الوظيفية مدخل نظري، ط2، دار الكتاب الجديد المتحدة، بيروت-لبنان، 2010، ص163-164-165-166-167.',
        'أحمد المتوكل، الوظيفة والبنية مقاربات وظيفية لبعض قضايا التركيب في اللغة العربية، د ط، د ن، الزباط، 1993، ص 21-22.'
      ]
    },
    {
      id: 10,
      title: 'البنية العامة للحمل',
      content: [
      ...
      sources: [
        'أحمد المتوكل، اللسانيات الوظيفية مدخل نظري، ط2، دار الكتاب الجديد المتحدة، بيروت-لبنان، 2010، ص144.',
        'أحمد المتوكل، الوظيفة والبنية مقاربات وظيفية لبعض قضايا التركيب في اللغة العربية، د ط، د ن، الزباط، 1993، ص32.'
      ]
    },
    {
      id: 11,
      title: 'المعلومات الممثل لها من خلال صورنة الحمل في شكل إطار حملي',
      content: [
        'المعلومات الممثل لها من خلال صورنة الحمل في شكل إطار حملي تتضمن:',
        'التحديد الدقيق للوظائف والعلاقات داخل البنية الحملية',
        '[ف (س1، منف، فا) (س2، متق، مف)]'
      ],
      sources: [
        'أحمد المتوكل، الوظيفة والبنية مقاربات وظيفية لبعض قضايا التركيب في اللغة العربية، د ط، د ن، الزباط، 1993، ص32-33.'
      ]
    }
  ];
