...
const Rules = () => {
  ...
  const rulesData = [
    ...
    },
    {
      ...
      content: [
        'البنية العامة للحمل تتضمن المعلومات الأساسية للتحليل الوظيفي:',
        '[ف، الحدود الموضوعات (س1...سن)، الحدود اللّواحق (ص1...صن)]',
        'هذه البنية تشكل الأساس لجميع التحليلات النحوية في النظرية الوظيفية'
      ],
      sources: [
        'أحمد المشوّك، البنيات الوظيفية مدخل نظري، ط2، دار الكتاب الجديد المتحدة، بيروت-لبنان، 2010، ص.144.',
        'أحمد المشوّك، البنية الوظيفية مقاربات نظرية ووظيفية لبعض قضايا التركيب في اللغة العربية، جـ 1، د ت، الزيلع 1993، ص.32.'
      ]
    },
    {
      id: 11,
      ...
      sources: [
        'أحمد المشوّك، البنية الوظيفية مقاربات نظرية ووظيفية لبعض قضايا التركيب في اللغة العربية، جـ 1، د ت، الزيلع 1993، ص.33-32.'
      ]
    }
  ];
